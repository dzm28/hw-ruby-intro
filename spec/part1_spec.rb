...
describe 'Ruby intro part 1' do
  describe '#sum' do
    ...
    it 'returns correct sum [2 points]', points: 2 do
    ...
    it 'works on the empty array [1 points]', points: 1 do
  ...
  describe '#max_2_sum' do
    ...
    it 'returns the correct sum [0.7 points]', points: 0.7 do
      expect(max_2_sum([1, 2, 3, 4, 5])).to be_a Integer
      expect(max_2_sum([1, 2, 3, 4, 5])).to eq(9)
      expect(max_2_sum([1, -2, -3, -4, -5])).to eq(-1)
    end

    it 'works even if 2 largest values are the same [0.3 points]', points: 0.3 do
      expect(max_2_sum([1, 2, 3, 3])).to eq(6)
    end

    it 'returns zero if array is empty [1 points]', points: 1 do
      expect(max_2_sum([])).to be_zero
    end

    it 'returns value of the element if just one element [1 points]', points: 1 do
  ...
  describe '#sum_to_n' do
    ...
    it 'returns true when any two elements sum to the second argument [3 points]', points: 3 do
    ...
    it 'returns false for any single element array [0.5 points]', points: 0.5 do
    ...
    it 'returns false for an empty array [0.5 points]', points: 0.5 do
